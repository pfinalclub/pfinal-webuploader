<?php
    ...
    function pf_css()
    {
        return '<!--webuploader css--><link rel="stylesheet" type="text/css" href="'.asset(
                '/vendor/pfinalWebuploader/dist/webuploader.css'
            ).'"><!--pf_style css--><link href="https://cdn.bootcss.com/font-awesome/4.6.3/css/font-awesome.min.css" rel="stylesheet">
<link rel="stylesheet" type="text/css" href="'.asset('/vendor/pfinalWebuploader/dist/css/pf_style.css"').'>';
    }
    
    function pf_js($option = [])
    {
        if (count($option) <= 0) {
            return '<script type="text/javascript">window.jQuery || document.write(unescape("%3Cscript%20type%3D%22text/javascript%22%20src%3D%22//cdn.bootcss.com/jquery/3.2.1/jquery.min.js%22%3E%3C/script%3E"));</script><script type="text/javascript" src="'.asset(
                    '/vendor/pfinalWebuploader/dist/webuploader.js'
                ).'"></script>';
        } else {
            ...
            foreach ($option as $item) {
                if (file_exists(public_path('/vendor/pfinalWebuploader/dist/webuploader.'.$item.'.js'))) {
                    $js_list .= '<script type="text/javascript" src="'.asset(
                            '/vendor/pfinalWebuploader/dist/webuploader.'.$item.'.js'
                        ).'"></script>';
                } else {
...
PF_2;
    ...
    function _set_uploader($el, $upload_img_server, $option, $callback)
    {
        ...
        $swf = asset('/vendor/pfinalWebuploader/dist/Uploader.swf');
        $script = "
